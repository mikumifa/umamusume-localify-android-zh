...
namespace logger
{
    ...
    {
        string jsonFolderPath = string("/sdcard/Android/data/").append(Game::GetCurrentPackageName()).append("/").append("original_data/");
        ...
        SQLite::Statement query(*db, string("SELECT ").append(targetField).append(" FROM ").append(tableName));
    ...
    void dump_db_texts()
    {
        string path = string("/data/data/").append(Game::GetCurrentPackageName()).append("/files/master/master.mdb");
    ...
    void write_static_dict(const vector<u16string> &dict)
    {
        if (g_enable_logger)
        {
            string jsonPath = string("/sdcard/Android/data/").append(Game::GetCurrentPackageName()).append("/static.json");
                                   ...
                                   const vector<pair<const string, const u16string>> &not_matched)
    {
        if (g_enable_logger)
        {
            string jsonPath = string("/sdcard/Android/data/").append(Game::GetCurrentPackageName()).append("/");
